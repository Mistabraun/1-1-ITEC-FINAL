...
function handleURLParams(productsJSON) {
  ...
  searchElement.addEventListener("input", function () {
    filterSearch(searchElement.value);
  });
  filterItems();
}

// function handleURLParams(productsJSON) {
//   let gender = getGenders(urlParams.get("gender"));
//   console.log(gender);
//   gender.forEach(function (value) {
//     let upperCaseGender = capitalizeFirstLetter(value);
//     let genderItems = productsJSON[upperCaseGender];
//     let category = urlParams.get("category") || CATEGORY;
//     console.log(upperCaseGender, genderItems[category]);
//   });
// }
